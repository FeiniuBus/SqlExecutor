...
namespace FeiniuBus.SqlExecutor
{
    ...
    {
        public static IServiceCollection AddSqlExecutor<TSqlExecutor>(this IServiceCollection services, SqlExecutorOptions options)
        ...
        public static IServiceCollection AddSqlExecutor<TISqlExecutor, TSqlExecutor>(this IServiceCollection services, SqlExecutorOptions options)
