...
{
    public sealed class OperationLessThanConverter : BaseOperationConverter
    {
        public OperationLessThanConverter(LinqContext context, IEnumerable<IRelationConverter> relationConverters) :
        ...
        {
            return clientType == ClientTypes.EntityFramework && operation == QueryOperations.LessThan;
        }
