...
{
    public sealed class OperationGreaterConverter : BaseOperationConverter
    {
        public OperationGreaterConverter(LinqContext context, IEnumerable<IRelationConverter> relationConverters) :
        ...
        {
            return clientType == ClientTypes.EntityFramework && operation == QueryOperations.GreaterThan;
        }
